...
mixin _$PatientData {
 ...
 Gender? get sex; bool get onDialysis; AscitesSeverity get ascites; EncephalopathyGrade get encephalopathy;
...
@useResult
$Res call({
 Units units, double? bilirubinSi, double? inr, double? pt, double ptControl, double? creatinineSi, int? sodium, double? albuminGl, Gender? sex, bool onDialysis, AscitesSeverity ascites, EncephalopathyGrade encephalopathy
});
...
/// Create a copy of PatientData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? units = null,Object? bilirubinSi = freezed,Object? inr = freezed,Object? pt = freezed,Object? ptControl = null,Object? creatinineSi = freezed,Object? sodium = freezed,Object? albuminGl = freezed,Object? sex = freezed,Object? onDialysis = null,Object? ascites = null,Object? encephalopathy = null,}) {
...
as Gender?,onDialysis: null == onDialysis ? _self.onDialysis : onDialysis // ignore: cast_nullable_to_non_nullable
as bool,ascites: null == ascites ? _self.ascites : ascites // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Units units,  double? bilirubinSi,  double? inr,  double? pt,  double ptControl,  double? creatinineSi,  int? sodium,  double? albuminGl,  Gender? sex,  bool onDialysis,  AscitesSeverity ascites,  EncephalopathyGrade encephalopathy)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PatientData() when $default != null:
return $default(_that.units,_that.bilirubinSi,_that.inr,_that.pt,_that.ptControl,_that.creatinineSi,_that.sodium,_that.albuminGl,_that.sex,_that.onDialysis,_that.ascites,_that.encephalopathy);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Units units,  double? bilirubinSi,  double? inr,  double? pt,  double ptControl,  double? creatinineSi,  int? sodium,  double? albuminGl,  Gender? sex,  bool onDialysis,  AscitesSeverity ascites,  EncephalopathyGrade encephalopathy)  $default,) {final _that = this;
switch (_that) {
case _PatientData():
return $default(_that.units,_that.bilirubinSi,_that.inr,_that.pt,_that.ptControl,_that.creatinineSi,_that.sodium,_that.albuminGl,_that.sex,_that.onDialysis,_that.ascites,_that.encephalopathy);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Units units,  double? bilirubinSi,  double? inr,  double? pt,  double ptControl,  double? creatinineSi,  int? sodium,  double? albuminGl,  Gender? sex,  bool onDialysis,  AscitesSeverity ascites,  EncephalopathyGrade encephalopathy)?  $default,) {final _that = this;
switch (_that) {
case _PatientData() when $default != null:
return $default(_that.units,_that.bilirubinSi,_that.inr,_that.pt,_that.ptControl,_that.creatinineSi,_that.sodium,_that.albuminGl,_that.sex,_that.onDialysis,_that.ascites,_that.encephalopathy);case _:
  return null;
...
class _PatientData extends PatientData {
  const _PatientData({this.units = Units.si, this.bilirubinSi, this.inr, this.pt, this.ptControl = 12.0, this.creatinineSi, this.sodium, this.albuminGl, this.sex, this.onDialysis = false, this.ascites = AscitesSeverity.none, this.encephalopathy = EncephalopathyGrade.none}): super._();
...
// Stored in g/L
@override final  Gender? sex;
@override@JsonKey() final  bool onDialysis;
...
/// Create a copy of PatientData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? units = null,Object? bilirubinSi = freezed,Object? inr = freezed,Object? pt = freezed,Object? ptControl = null,Object? creatinineSi = freezed,Object? sodium = freezed,Object? albuminGl = freezed,Object? sex = freezed,Object? onDialysis = null,Object? ascites = null,Object? encephalopathy = null,}) {
